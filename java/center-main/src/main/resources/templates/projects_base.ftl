	...
	<div class="row">
		<div class="col-md-8">
			<form id="project_edit_form" role="form" class="form-horizontal">
				<input type="hidden" name="id" v-model="editRow.id" />
				<div class="form-group">
					<!---->
					<label class="col-sm-2 control-label">显示名称<span class="glyphicon glyphicon-asterisk required"></span></label>
					<div class="col-sm-9">
						<input v-model="editRow.displayName" type="text" name="displayName" placeholder="请输入显示名称" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">备注</label>
					<div class="col-sm-9">
						<textarea v-model="editRow.memo" rows="3" name="memo" placeholder="请输备注" required="required" class="form-control"></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-9">
						<div class="checkbox">
							<label><input v-model="editRow.needCheck" type="checkbox" name="needCheck" value="true">是否需要检查状态 </label>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-9">
						<div class="checkbox">
							<label><input v-model="editRow.sendWarn" type="checkbox" name="sendWarn" value="true">宕机时是否需要报警给相关人员 </label>
