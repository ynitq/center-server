...
/**
 * <pre>
 * RightsDef对象的 view model专门用于传递数据给页面。
 ...
 */
public class RightsDefViewModel extends BaseViewModel<RightsDefObj, RightsDef> {

	public RightsDefViewModel(RightsDefObj obj) {
		super(obj);
	}
}
